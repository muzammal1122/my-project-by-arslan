...
const OurFinanceServes = (props: Props) => {
  return (
    <div className="container mx-auto w max-w-screen-lg pt-10">
      <h1 className="w-72 text-2xl font-bold pb-6">
        Our <span className="text-blue-500">Finance Services</span>
      </h1>
...
export default OurFinanceServes;
